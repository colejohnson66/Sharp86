...
public class VectorRegisterByteAccessor : IEnumerable<byte>
{
    ...
    public byte this[int index]
    {
        get
        {
            Debug.Assert(index is >= 0 and < VectorRegister.BYTE_LENGTH);
...
public class VectorRegisterWordAccessor : IEnumerable<ushort>
{
    ...
    public ushort this[int index]
    {
        get
        {
            Debug.Assert(index is >= 0 and < VectorRegister.WORD_LENGTH);
...
public class VectorRegisterDwordAccessor : IEnumerable<uint>
{
    ...
    public uint this[int index]
    {
        get
        {
            Debug.Assert(index is >= 0 and < VectorRegister.DWORD_LENGTH);
...
public class VectorRegisterQwordAccessor : IEnumerable<ulong>
{
    ...
    public ulong this[int index]
    {
        get
        {
            Debug.Assert(index is >= 0 and < VectorRegister.QWORD_LENGTH);
