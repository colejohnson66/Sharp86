...
public static class Broadcastss
{
    ...
    public static void VxMdV128(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [VEX.256.66.0F38.W0 18 /r] VBROADCASTSS ymm1, m32
    public static void VyMdV256(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    ...
    public static void VyUxV256(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
...
public static class Broadcastsd
{
    ...
    public static void VyMqV256(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
...
public static class Broadcastf128
{
    ...
    public static void VyMxV256(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
}
...
public static class Broadcastf32x4
{
    ...
    public static void VyMxE256(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [EVEX.512.66.0F38.W0 1A /r] VBROADCASTF32X4 zmm1 {k1}{z}, m128
    public static void VzMxE512(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
}
...
public static class Broadcastf32x8
{
    ...
    public static void VzMyE512(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
}
