...
public static class Gatherdpd
{
    ...
    public static void VxVMdHxV128(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [VEX.256.66.0F38.W1 92 /r] VGATHERDPD ymm1, vm32y, ymm2
    public static void VyVMdHyV256(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [EVEX.128.66.0F38.W1 92 /vsib] VGATHERDPD xmm1 {k1}{z}, vm32x
    public static void VxVMdE128(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [EVEX.256.66.0F38.W1 92 /vsib] VGATHERDPD ymm1 {k1}{z}, vm32y
    public static void VyVMdE256(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [EVEX.512.66.0F38.W1 92 /vsib] VGATHERDPD zmm1 {k1}{z}, vm32z
    public static void VzVMdE512(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
}
public static class Gatherqpd
{
    // [VEX.128.66.0F38.W1 93 /r] VGATHERQPD xmm1, vm64x, xmm2
    public static void VxVMqHxV128(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [VEX.256.66.0F38.W1 93 /r] VGATHERQPD ymm1, vm64y, ymm2
    public static void VyVMqHyV256(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [EVEX.128.66.0F38.W1 93 /vsib] VGATHERQPD xmm1 {k1}{z}, vm64x
    public static void VxVMqE128(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [EVEX.256.66.0F38.W1 93 /vsib] VGATHERQPD ymm1 {k1}{z}, vm64y
    public static void VyVMqE256(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [EVEX.512.66.0F38.W1 93 /vsib] VGATHERQPD zmm1 {k1}{z}, vm64z
    public static void VzVMqE512(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
}
...
public static class Gatherpf0dps
{
    ...
    public static void VMdE512(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
}
public static class Gatherpf0qps
{
    // [EVEX.512.66.0F38.W0 C7 /1 /vsib] VGATHERPF0QPS vm64z {k1}
    public static void VMqE512(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
}
