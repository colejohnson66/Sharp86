...
public static partial class Mov
{
    ...
    // [8C /r] MOV r/m16, sreg
    public static void EwSw(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [8C /r] MOV r16/r32/m16, sreg
    public static void EdSw(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [REX.W 8C /r] MOV r64/m16, sreg
    public static void EqSw(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [8E /r] MOV sreg, r/m16
    // [REX.W 8E /r] MOV sreg, r/m64
    public static void SwEw(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [A0 ob] MOV AL, moffs8
    // [REX.W A0 ob] MOV AL, moffs8
    public static void ALOb(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [A1 ow] MOV AX, moffs16
    public static void AXOw(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [A1 od] MOV EAX, moffs32
    public static void EAXOd(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [REX.W A1 oq] MOV RAX, moffs64
    public static void RAXOq(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [A2 ob] MOV moffs8, AL
    // [REX.W A2 ob] MOV moffs8, AL
    public static void ObAL(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [A3 ow] MOV moffs16, AX
    public static void OwAX(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [A3 od] MOV moffs32, EAX
    public static void OdEAX(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [REX.W A3 oq] MOV moffs64, RAX
    public static void OqRAX(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [B0+rb ib] MOV r8, imm8
    // [REX B0+rb ib] MOV r8, imm8
    public static void ZbIb(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [B8+rw iw] MOV r16, imm16
    public static void ZwIw(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [B8+rd id] MOV r32, imm32
    public static void ZdId(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [REX.W B8+rd io] MOV r64, imm64
    public static void ZqIq(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
