...
public static class Movq
{
    ...
    public static void PqEq(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [NP REX.W 0F 7E /r] MOVQ r/m64, mm
    public static void EqPq(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    ...
    public static void QqPq(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    ...
    public static void EqVx(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    ...
    public static void VxEqV128(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [VEX.128.66.0F.W1 7E /r] VMOVQ r/m64, xmm1
    public static void EqVxV128(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    ...
    public static void VxEqE128(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
    // [EVEX.128.66.0F.W1 7E /r] VMOVQ r/m64, xmm1
    public static void EqVxE128(CpuCore cpu, DecodedInstruction instr) => throw new NotImplementedException();
